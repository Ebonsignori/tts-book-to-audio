...
3. Character names should always be in snake_case and consistent with how they appear in the text.
4. Do not modify any text that is not dialogue (e.g., character actions, narrative descriptions).
5. If dialogue is interrupted by a description or action, apply the tag to each individual segment of dialogue.
6. Determine the gender of each character based on the context and append '-m' for male or '-f' for female to the character name tag.
...
Do not change any of the text other than surrounding dialogue in character tags with appropriate gender suffixes.""",
...
User input:\n\n```\n""",
    "user_message_prefix": "Text input:\n\n```",
    "user_message_suffix": "\n```",
    "token_limits": {
